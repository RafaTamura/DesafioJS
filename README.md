# Desafio JavaScript AtoS e UFN 
- Repositório criado para realizar os exercícios de JavaScript.
Nele é apresentado 10 exercícios organizados em páginas.
...
3 - Crie uma página com uma lista <b>(select - RadioButton)</b> com 4 opções de cores. Ao selecionar uma opção de cor, altere o plano de fundo da página para a cor específica.
